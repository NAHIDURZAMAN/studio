...
import { Package, DollarSign, TrendingUp, Send, ShoppingCart } from "lucide-react"
import { Skeleton } from "../ui/skeleton"
import type { Order } from "@/types"

export default function StatsCards() {
  const [stats, setStats] = useState({ totalOrders: 0, processing: 0, delivered: 0 })
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      if (error) {
        ...
        const processingOrders = data.filter(o => o.order_status !== 'delivered' && o.order_status !== 'cancelled');
