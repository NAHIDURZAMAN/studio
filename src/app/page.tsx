...
const mockProducts: Product[] = [
  ...
  { id: 3, name: 'Mirpur Midnight Hoodie', category: 'Hoodies', price: 2500, color: 'Seasonal Colors', image: 'https://placehold.co/400x500.png', stock: 12, description: "Stay cozy during late-night hangouts with this seasonal colored hoodie. A true Mirpur original.", dataAiHint: "maroon hoodie" },
  ...
  { id: 6, name: 'Gameday Champion Jersey', category: 'Jerseys', price: 1900, color: 'Seasonal Colors', image: 'https://placehold.co/400x500.png', stock: 20, description: "Rep your style with our Gameday Champion jersey, available in this season's hottest color.", dataAiHint: "blue jersey" },
